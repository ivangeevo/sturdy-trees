...
public class LogBotVar3 extends ConvertingBlock implements LogBlockStacks {
    ...
    public VoxelShape getOutlineShape(BlockState state, BlockView world, BlockPos pos, ShapeContext context) {
        ...
        double fromX1 = 7.0 / 16.0;
        double fromY1 = 0.0;
        double fromZ1 = 7.0 / 16.0;
        double toX1 = 9.0 / 16.0;
        double toY1 = 15.0 / 16.0;
        double toZ1 = 9.0 / 16.0;

        double fromX2 = 6.0 / 16.0;
        double fromY2 = 0.0;
        double fromZ2 = 6.0 / 16.0;
        double toX2 = 10.0 / 16.0;
        double toY2 = 13.0 / 16.0;
        double toZ2 = 10.0 / 16.0;

        double fromX3 = 5.0 / 16.0;
        double fromY3 = 0.0;
        double fromZ3 = 5.0 / 16.0;
        double toX3 = 11.0 / 16.0;
        double toY3 = 11.0 / 16.0;
        double toZ3 = 11.0 / 16.0;

        double fromX4 = 4.0 / 16.0;
        double fromY4 = 0.0;
        double fromZ4 = 4.0 / 16.0;
        double toX4 = 12.0 / 16.0;
        double toY4 = 9.0 / 16.0;
        double toZ4 = 12.0 / 16.0;

        double fromX5 = 3.0 / 16.0;
        double fromY5 = 0.0;
        double fromZ5 = 3.0 / 16.0;
        double toX5 = 13.0 / 16.0;
        double toY5 = 7.0 / 16.0;
        double toZ5 = 13.0 / 16.0;

        double fromX6 = 2.0 / 16.0;
        double fromY6 = 0.0;
        double fromZ6 = 2.0 / 16.0;
        double toX6 = 14.0 / 16.0;
        double toY6 = 5.0 / 16.0;
        double toZ6 = 14.0 / 16.0;

        double fromX7 = 1.0 / 16.0;
        double fromY7 = 0.0;
        double fromZ7 = 1.0 / 16.0;
        double toX7 = 15.0 / 16.0;
        double toY7 = 3.0 / 16.0;
        double toZ7 = 15.0 / 16.0;

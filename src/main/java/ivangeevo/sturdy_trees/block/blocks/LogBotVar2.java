...
public class LogBotVar2 extends ConvertingLogBlock implements LogBlockStacks, SideModUtils {
    ...
    public void afterBreak(World world, PlayerEntity player, BlockPos pos, BlockState state, @Nullable BlockEntity blockEntity, ItemStack stack) {
        ...
        if (!world.isClient) {
            if (state.isOf(SturdyTreesBlocks.LOG_BOT_VAR2)) {
                world.setBlockState(pos, SturdyTreesBlocks.LOG_BOT_VAR3.getDefaultState());
            } else if (state.isOf(SturdyTreesBlocks.LOG_BOT_VAR2)) {
                world.setBlockState(pos, SturdyTreesBlocks.LOG_BOT_VAR3.getDefaultState());
            } else if (state.isOf(SturdyTreesBlocks.LOG_BOT_VAR2)) {
                world.setBlockState(pos, SturdyTreesBlocks.LOG_BOT_VAR3.getDefaultState());
            } else if (state.isOf(SturdyTreesBlocks.LOG_BOT_VAR2)) {

...
public class LogBotVar2 extends ConvertingBlock implements LogBlockStacks {
    ...
    public VoxelShape getOutlineShape(BlockState state, BlockView world, BlockPos pos, ShapeContext context) {
        ...
        double fromX1 = 3.0 / 16.0;
        double fromY1 = 0.0;
        double fromZ1 = 3.0 / 16.0;
        double toX1 = 13.0 / 16.0;
        double toY1 = 16.0 / 16.0;
        double toZ1 = 13.0 / 16.0;

        // Define the dimensions for the second element
        double fromX2 = 2.0 / 16.0;
        double fromY2 = 0.0;
        double fromZ2 = 2.0 / 16.0;
        double toX2 = 14.0 / 16.0;
        double toY2 = 5.0 / 16.0;
        double toZ2 = 14.0 / 16.0;

        // Define the dimensions for the third element
        double fromX3 = 1.0 / 16.0;
        double fromY3 = 0.0;
        double fromZ3 = 1.0 / 16.0;
        double toX3 = 15.0 / 16.0;
        double toY3 = 3.0 / 16.0;
        double toZ3 = 15.0 / 16.0;
